...
public class GUITest {
    ...
    @Test
    public void testPreviousLevelButton1() {
        frame.textBox("levelToJumpTextField").enterText("1");
        frame.button("jumpButton").click();
        frame.button("previousButton").click();
    ...
    public void testNextLevelButton() {
        ...
        // 断言当前关卡是否正确更新
        frame.label("levelLabel").requireText("第3/100关");
    }

    @Test
    public void testNextLevelButton1() {
    ...
    public void testJumpToLevel1() {
        ...
        // 断言当前关卡是否跳转到指定的关卡
        frame.label("levelLabel").requireText("第50/100关");
    }

    @Test
    public void testJumpToLevel2() {
        // 测试跳转到指定关卡的功能
        frame.textBox("levelToJumpTextField").enterText("99");
        frame.button("jumpButton").click();
        ...
        // 断言当前关卡是否跳转到指定的关卡
        frame.label("levelLabel").requireText("第99/100关");
    }

    @Test
    public void testJumpToLevel3() {
        // 测试跳转到指定关卡的功能
        frame.textBox("levelToJumpTextField").enterText("100");
        frame.button("jumpButton").click();
    ...
    @Test
    public void testJumpToLevel4() {
        // 测试跳转到指定关卡的功能
        frame.textBox("levelToJumpTextField").enterText("2.5");
        frame.button("jumpButton").click();
    ...
    @Test
    public void testJumpToLevel5() {
        // 测试跳转到指定关卡的功能
        frame.textBox("levelToJumpTextField").enterText("101");
        frame.button("jumpButton").click();
